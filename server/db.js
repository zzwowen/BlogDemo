...
const database = mongoose.connect('mongodb://127.0.0.1:27017/test')
...
const db = {
  ...
  cartsModel: database.model('cartsModel', cartsSchema),
    imgsModel:database.model('imgsModel', imgSchema),
    articleModel:database.model('article', articleSchema),
